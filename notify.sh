...
url=https://api.github.com/repos/nemo/el-validate-table/releases/latest
...
msg='{"msgtype": "markdown", "markdown": {"title": "el-validate-table更新", "text": "@所有人\n# [el-validate-table]('$html_url')\n'$body'"}}'
